...
class OrganizationPage:
    ...
    org_name=(By.XPATH, '//label[text()="Name"]/ancestor::div[@class="MuiFormControl-root input-field__container MuiFormControl-fullWidth"]/div/input')
    ...
    type = (By.XPATH, '//div[text()="Select Type"]/ancestor::div[@class="select__value-container css-1hwfws3"]/div/div/input')
    ...
    # ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    # tin details section
    add_tin_button = (By.XPATH, "//span[contains(text(), 'TAX')]")
    ...
    def enter_number_street(self,numbervalue):
        ...
        self.dr.find_element(*OrganizationPage.number_Street).send_keys(numbervalue)

    def enter_building_value(self,buildingvalue):
        self.dr.find_element(*OrganizationPage.building_floor_suite).send_keys(buildingvalue)

    def enter_zipcode(self,zipcode):
        self.dr.find_element(*OrganizationPage.zip).send_keys(zipcode)

    def select_Type(self,type):
        self.dr.find_element(*OrganizationPage.type).send_keys(type)
        act = ActionChains(self.dr)
        act.key_down(Keys.ENTER).perform()

    def click_org_Save_button(self):
    ...
    def getSucessMessage(self):
        ...
        ele = self.dr.find_element(*OrganizationPage.success_mesg)
        return ele

    def click_add_contact(self):
        pass

    def enter_contact_first_name(self):
        pass

    def enter_contact_middle_name(self):
        pass

    def enter_contact_last_name(self):
        pass

    def select_contact_role(self):
        pass

    def click_contact_save_button(self):
        self.dr.find_element(*OrganizationPage.contact_save_button).click()

    def enter_orgName(self,name):
        self.dr.find_element(*OrganizationPage.org_name).send_keys(name)
