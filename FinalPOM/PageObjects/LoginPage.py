...
class LoginPage:
    ...
    def clickContinue(self):
        wait1 = wait.WebDriverWait(self.dr, 10)
        wait1.until(expected_conditions.presence_of_element_located((LoginPage.continuebutton)))
        self.dr.find_element(*LoginPage.continuebutton).click()

    def clickLogin(self):
        self.dr.find_element(*LoginPage.loginbutton).click()
        orgObj = OrganizationPage(self.dr)
        return orgObj

    def clickRegistrationLink(self):
        wait2 = wait.WebDriverWait(self.dr, 15)
